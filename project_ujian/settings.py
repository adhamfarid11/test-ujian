"""
Django settings for project_ujian project.
...
# (e.g. Heroku).
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-xs)$0jxkk=@y%-2-ibyrdu5w#x9u#nqbo^sv%s1iw31o=t2am3')
...
ROOT_URLCONF = 'project_ujian.urls'
...
WSGI_APPLICATION = 'project_ujian.wsgi.application'
